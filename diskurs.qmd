---
title: "Anatomija diskursa Tematska mapa katoličkog digitalnog prostora u Hrvatskoj (2021-2023)"
date: last-modified
format:
  html:
    theme: cosmo
...
files <- list.files(files <- list.files("C:/Users/lsikic/Luka C/HKS/Projekti/Digitalni Kat/SHKM/Podatci/Language model", full.names = TRUE, pattern = "\\.rds")
...
## Vizualni sažetak korpusa Oblak riječi
...
### Dinamika glavnih tema (2021 do 2023)
