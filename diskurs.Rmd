...
```{r data-preparation, include=FALSE, eval=FALSE}
...
```{r emotional-analysis, include=FALSE, eval=FALSE}
...
```{r analyze-atmosphere, include=FALSE}
...
conflict_lexicon <- unique(c(
  ...
  (crosentilex_full %>% filter(sentiment_value <= -0.75) %>% pull(word)), # Stroži prag
