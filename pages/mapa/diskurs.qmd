---
title: "Atmosfera diskursa — emocionalna i konfliktna mapa katoličkog digitalnog prostora (2021.–2025.)"
...
ggplot(heatmap_data, aes(x = dominant_emotion, y = dominant_topic, fill = avg_sentiment)) +
  ...
  geom_text(aes(label = round(avg_sentiment, 2)), size = 4, color = "black") +
...
Boja veze označava prosječni tonalitet, gdje plave nijanse označavaju pozitivno obojene narativne spojeve, a crne nijanse negativno obojene. Debljina veze označava prosječni intenzitet konfliktnog jezika, gdje deblje linije upućuju na konfliktnije narative. Prozirnost veze označava pouzdanost veze, mjerenu brojem tekstova na kojima se temelji analiza, gdje tamnije linije predstavljaju statistički robusnije nalaze.
...
graph_from_data_frame(graph_data, directed = FALSE) %>%
  ggraph(layout = "fr") +
    ...
    geom_node_text(aes(label = str_wrap(name, 15)), color = "black", size = 4) +
