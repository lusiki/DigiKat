...
Ovaj dokument predstavlja prvu analitičku fazu projekta koji istražuje reprezentaciju katoličke tematike u digitalnom medijskom prostoru Hrvatske. Analiza obuhvaća korpus od preko 610.000 medijskih objava prikupljenih između 1. siječnja 2021. i 31. prosinca 2025. Cilj je stvoriti temeljni pregled arene u kojoj se odvijaju rasprave o katoličkim temama.

Istraživanje primjenjuje kvantitativnu analizu medijskog sadržaja kako bi identificiralo strukturne karakteristike ekosustava. Analitički pristup strukturiran je u tri faze. Prva faza analizira platformske karakteristike prema volumenu produkcije, angažmanu publike i dosegu sadržaja. Druga faza identificira najproduktivnije i najutjecajnije medijske izvore. Treća faza sintetizira sve nalaze kroz sveobuhvatnu mapu utjecaja.
...
Razumijevanje ekosustava počinje analizom glavnih platformi. Svaka platforma nudi specifične komunikacijske mogućnosti koje oblikuju način na koji akteri proizvode sadržaj i način na koji publika reagira. Ova sekcija ispituje tri temeljne metrike koje određuju digitalnu komunikaciju o katoličkoj tematici.
...
Prelazak na analizu angažmana otkriva kako struktura ekosustava postaje složenija kada se fokus pomakne s produkcije na recepciju sadržaja.
...
Prvo rangiranje aktera provodimo prema najdirektnijoj mjeri angažmana publike, odnosno prema ukupnom broju interakcija. Rezultati otkrivaju jasnu podjelu prema platformskim karakteristikama.
...
YouTube platformu karakteriziraju isključivo specijalizirani kanali. Među njima prednjače LaudatoTV i T Studio, uz značajnu prisutnost pojedinačnih svećenika i župa. Ovi akteri grade dugoročne odnose s publikom kroz redovitu video produkciju.

Facebook scenu karakterizira mješavina mainstream medija i specijaliziranih stranica. To odražava hibridnu prirodu platforme koja spaja informativnu i zajedničarsku funkciju.
