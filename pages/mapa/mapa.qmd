...
plot_volume <- platform_summary %>%
  ...
  geom_col() +
  geom_text(aes(label = comma(total_posts, accuracy = 1, big.mark = ".")), hjust = -0.1, size = 4, color = "black") +
...
plot_interactions <- platform_summary %>%
  ...
  geom_col() +
  geom_text(aes(label = comma(total_interactions, accuracy = 1, big.mark = ".")), hjust = -0.1, size = 4, color = "black") +
  facet_wrap(~year, scales = "free_y") +
