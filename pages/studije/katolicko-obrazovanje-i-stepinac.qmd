...
description: "Studija analizira katoličko obrazovanje i Alojzija Stepinca kao dva različita mjesta sjećanja u hrvatskim digitalnim medijima."
author:
...
![Odnos učestalosti i lokalne veze s prošlošću za osam glavnih sidara.](../../assets/papers/katolicko-obrazovanje-i-stepinac-anchor.png){#fig-education-anchor fig-alt="Crno-bijeli raspršeni grafikon pokazuje da je Stepinac mnogo snažnije povezan s prošlošću od češćih obrazovnih ustanova." width="3300" height="2040"}
...
![Konfesionalni i nekonfesionalni udjeli među objavama s klasificiranim izvorom.](../../assets/papers/katolicko-obrazovanje-i-stepinac-sources.png){#fig-education-sources fig-alt="Vodoravni složeni stupci pokazuju da Stepinac ima mješovitiji profil izvora od katoličkih škola i vjeronauka." width="3150" height="1860"}
