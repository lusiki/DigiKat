...
3. **Work on a SAMPLE by default.** Draw a stratified 2–5% sample (platform × year, seeded) — or use
   `data/sample/` — unless the user explicitly needs the full corpus. Never load 710k rows into context.
