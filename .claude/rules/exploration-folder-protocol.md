...
`explorations/` is the sandbox for throwaway analyses a 710k-row corpus invites. Lower rigor (~60/100),
...
2. Heavy slices: `data.table` + sample first; don't load 710k rows casually.
