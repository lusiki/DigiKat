...
Konačno, spajamo sve u jednu, sofisticiranu vizualizaciju. "Mapa Utjecaja" prikazuje aktere u dvodimenzionalnom prostoru **angažmana (X-os)** i **dosega (Y-os)**. Ovo nam omogućuje da identificiramo četiri osnovna arhetipa:
...
Ova inicijalna analiza ekosustava otkriva višeslojnost digitalne arene. Ključni nalazi su:
